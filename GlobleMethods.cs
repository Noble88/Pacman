...
public class GlobalMethods {
  ...
  public static bool isDesWalkable(Vector2Int des, ArrayList allowedWalkables) {
    return allowedWalkables.Contains(LevelManager.LevelBackEnd.getE(des, false));
  }
  ...
  public static Vector2Int moveCharOnLevel(Vector2Int pos, Vector2Int des, char sym) { //Sym = symbol
    LevelManager.LevelBackEnd.flipE(pos, true); //deletePlayer
    LevelManager.LevelBackEnd.setE(des, sym, true); //add player
    return des;
  }
